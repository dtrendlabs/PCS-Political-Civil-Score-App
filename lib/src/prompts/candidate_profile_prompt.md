...
- **Every `source` field MUST contain a valid, real, publicly accessible URL** (e.g., from myneta.info, adrindia.org, news websites, eci.gov.in). If no URL is available, use `"N/A"`.
...
```json
{
  "candidate_profile": {
    ...
    "source": "URL to official profile or election affidavit"
  },
  "financial_summary": {
    "total_assets": {
      ...
      "source": "URL to asset declaration or affidavit"
    },
    "movable_assets_breakdown": {
      "cash_in_hand": "Cash amount",
      "properties": [
        {
          "property_type": "Type of property (e.g., Land, House, Agricultural)",
          "value": "Value of property in INR",
          "source": "URL where this property info is mentioned"
        }
      ],
    ...
    "income_tax_status": {
      ...
      "source": "URL to ITR or tax related info"
    }
  },
  "criminal_background": {
    ...
    "case_details": [
      {
        ...
        "source": "URL of news article or court record about this case",
        "status": "Pending / Convicted / Acquitted / Dismissed"
      }
    ],
    "sources": "Source of criminal data (e.g., ADR, Election Commission affidavit)",
    "source_url": "Main URL for criminal record data (e.g., myneta.info page)"
  },
  "business_and_contracts": {
    ...
    "source": "URL to business or company information"
  },
  "controversies_and_notes": [
    {
      "controversy_description": "Description of the controversy",
      "source": "URL of the news article or report about this controversy",
      "corruption_indicators": "Corruption allegations or indicators, or clean record note"
    }
  ]
}
```
...
## Important Notes
- Data should be sourced from publicly available information: Election Commission affidavits, ADR (Association for Democratic Reforms), myneta.info, news reports.
...
- **All source URLs must be real, verifiable web links.** Prefer official sources like myneta.info, adrindia.org, eci.gov.in, or major news outlets.
